...
import { useGetProduct, type UseProductParams } from '../../../hooks/useProduct';
...
export const ProductsPage = () => {
  ...
  }, [selectedCategory, minPrice, maxPrice, brands, colors, sizes, origins, rating, page]);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        {/* Left Sidebar - Fixed */}
        <aside className={`${sidebarCollapsed ? 'w-20' : 'w-64'} flex-shrink-0 transition-all duration-300 mb-6`}>
